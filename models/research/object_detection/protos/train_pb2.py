...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_TRAINCONFIG'].fields_by_name['from_detection_checkpoint']._options = None
  _globals['_TRAINCONFIG'].fields_by_name['from_detection_checkpoint']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['batch_queue_capacity']._options = None
  _globals['_TRAINCONFIG'].fields_by_name['batch_queue_capacity']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['num_batch_queue_threads']._options = None
  _globals['_TRAINCONFIG'].fields_by_name['num_batch_queue_threads']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['prefetch_queue_capacity']._options = None
  _globals['_TRAINCONFIG'].fields_by_name['prefetch_queue_capacity']._serialized_options = b'\030\001'
  _globals['_TRAINCONFIG'].fields_by_name['max_number_of_boxes']._options = None
